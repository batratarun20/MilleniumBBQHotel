jQuery(document).ready(function($){
    ...
    function optionsframework_add_file(event, selector) {
        ...
        if ( optionsframework_upload ) {
            ...
            optionsframework_upload.on( 'select', function() {
                ...
                optionsframework_selector.find('.upload-button-wdgt').unbind().addClass('remove-file').removeClass('upload-button-wdgt').val('Change');
    ...
    function optionsframework_remove_file(selector) {
        ...
        selector.find('.remove-file').unbind().addClass('upload-button-wdgt').removeClass('remove-file').val('Upload');

	...
	class Swing_Lite_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'actions_required' => esc_html__('Required Plugins', 'swing-lite'),
					'recommended_plugins' => esc_html__('Recommended Plugins', 'swing-lite'),
					'demo_import' => esc_html__('Import Demo', 'swing-lite'),
					'free_vs_pro' => esc_html__('Free Vs Pro', 'swing-lite'),
					'changelog' => esc_html__('ChangeLog', 'swing-lite'),
			...
			public function welcome_admin_notice_display() {
				...
				if( is_admin() && ('themes.php' == $pagenow) /*&& (isset($_GET['activated']))*/ ) {
					...
					<div class="updated apwelcome-an notice notice-success is-dismissible">
						<h2><?php printf(esc_html__( 'Welcome!', 'swing-lite' )) ?></h2>
						<p class="about-desc"><?php /* translators: %s : Theme Name */ printf(esc_html__( 'Thank you for installing %1$s. It is now installed and ready to use. Here are some useful links to get started: ', 'swing-lite' ), $this->theme_name);  ?></p>
						<hr/>
							...
							<div class="apwelcome-column col-demos">
								<div>
									<h3>
										...
										<?php printf(esc_html__( 'Starter site demos!', 'swing-lite' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'You\'ve  got 1  great starter sites (Demos) to start with. By using one of these starter sites you\'ll get a great guidance on how to use the theme to its fullest and also save time to make your website. ', 'swing-lite' ), $this->theme_name, esc_url(admin_url( 'themes.php?page=welcome-page#demo_import' ) ) ); ?></p>
								</div>
								<div>
									<div class="button-wrapper">
										<a class="button button-primary button-hero install-now" href="<?php echo esc_url(admin_url( 'themes.php?page=welcome-page#demo_import' )) ?>"><?php esc_html_e( 'ready to use starter sites.', 'swing-lite' ); ?></a>
									</div>

									<?php printf( wp_kses_post( '<a class="options-page-btn notice-info-btn" href="%2$s">Or start setting up your theme now (without demo)!</a>', 'swing-lite' ), $this->theme_name, esc_url(admin_url( 'themes.php?page=welcome-page' ))  ); ?>

									<p><?php esc_html_e( 'You can also reach-out to us for any support during the theme setup and use.', 'swing-lite' ); ?></p>
									<a href="<?php echo esc_url('https://accesspressthemes.com/support/')?>" class=" ti-return-dashboard  button button-secondary  install-now" ><span><?php esc_html_e( 'Contact Support', 'swing-lite' ); ?></span></a>
							...
							<div class="apwelcome-column col-doc">
								<div>
									<h3>
										...
										<?php printf(esc_html__( 'Documentation', 'swing-lite' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'How to use %1$s! Here we\'ve a full and detailed documentation that explains how to use %1$s in its best. ', 'swing-lite' ), $this->theme_name  ); ?></p>
									<a href="<?php echo esc_url($this->strings['doc_link']);?>" class=" button" ><span><?php esc_html_e( 'Full Documentation', 'swing-lite' ); ?></span></a>

								</div>
								<div class="apwelcome-doc-btn">
									<a href="#" class=" button" ><span><?php esc_html_e( 'Return to your Dashboard', 'swing-lite' ); ?></span></a>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="welcome-section-wrapper is_loading">
									...
									<div class="notice-sidebar is_loading">
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Join in our social networks!','swing-lite') ?></h4>
											<p><?php echo esc_html__('Get connected, share your opinions and more via our social community: ', 'swing-lite'); ?></p>

											<p><a href="<?php echo esc_url('https://www.facebook.com/AccessPressThemes')?>"><?php echo esc_html('Join our Facebook Group','swing-lite') ?></a><?php echo esc_html__(' -to receive updates, offers and more.', 'swing-lite'); ?></p>

											<p><a href="<?php echo esc_url('https://www.youtube.com/channel/UCzD8I1moKISXDjAVr8dIf-w')?>"><?php echo esc_html('Subscribe our YouTube Channel','swing-lite') ?></a><?php echo esc_html__(' -for tutorials, videos and more.', 'swing-lite'); ?></p>

											<p><a href="<?php echo esc_url('https://twitter.com/apthemes')?>"><?php echo esc_html('Follow us on Twitter','swing-lite') ?></a><?php echo esc_html__(' -to stay updated. ', 'swing-lite'); ?></p>
										</div>
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Rate us!','swing-lite') ?></h4>
											<p><?php /* translators: %s : Theme Name */ printf(esc_html__('Are you enjoying %1$s? We would love to hear your feedback!', 'swing-lite'),$this->theme_name); ?></p>
											<a href="https://wordpress.org/support/theme/swing-lite/reviews/#new-post"><?php echo esc_html('Write a review','swing-lite') ?></a>
				...
				// Get Plugin Info
					...
					public function plugin_activation_callback() {
						...
						if(file_exists($plugin_file)) {
							...
							echo esc_html__('Plugin Does not Exists' , 'swing-lite');
						}

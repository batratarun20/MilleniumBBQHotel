...
<div id="primary" class="content-area room-page-lists">
					...
					<div class="list-layout">
	                 ...
	                 <?php } else {
	                 	...
	                 	<div class="no-search-results">
	                 		<h1><?php esc_html_e( 'No Search Results were found.', 'swing-lite' ); ?></h1>
	                 		<p><?php esc_html_e( 'Try Searching another keyword instead.', 'swing-lite' ); ?></p>
	                 		<?php get_search_form(); ?>
	                 	</div>
	                 	<?php
	                 }  ?>   
